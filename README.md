...
This is a simple script to download all [TUTicket](http://www.tuticket.de) stops as [GTFS-compatible CSV](https://developers.google.com/transit/gtfs/reference/stops-file).
